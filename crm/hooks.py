...
permission_query_conditions = {
	...
	"CRM Task": "crm.permissions.task.get_task_permission_query_conditions",
}
...
has_permission = {
	...
	"CRM Task": "crm.permissions.task.has_task_permission",
}
...
scheduler_events = {
	...
	"daily": [
		...
		"crm.api.instagram_metricas.daily_snapshot",
	...
	"cron": {
		"0 8 * * 1": ["crm.api.automacoes.weekly_job"],
...
after_migrate = [
	"crm.api.automacoes.after_migrate",
